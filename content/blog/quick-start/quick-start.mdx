...
title: Quick Start
date: "2021-04-27"
description: "A guide on using the Greenlight Gatsby Starter."
---

![Greenlight](./greenlight.jpg)
...
MDX files are Markdown files that also support **JavaScript** or **JSX** (the same syntax used by [React](https://reactjs.org/)). 
This means that you can extend Markdown with **JavaScript** **components** that we have made available for you to use.
