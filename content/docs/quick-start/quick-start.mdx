...
Greenlight is a starter template for deploying a very fast and slick website for posting Data Visualizations built with 
<a className="has-text-tableau" href="https://www.tableau.com/" target="_blank" rel="noreferrer"> Tableau </a>. Use 
Greenlight to setup a data portal at your company or use it to build a personal data blog. This application is designed 
to be fast and easy to deploy, without relying on servers - thus freeing you from having to maintain them!
